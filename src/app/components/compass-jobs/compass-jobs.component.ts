...
@Component({
  selector: 'app-compass-jobs',
  standalone: true,
  imports: [CommonModule, TranslateModule, FormsModule],
  templateUrl: './compass-jobs.component.html',
  styleUrl: './compass-jobs.component.scss',
})
export class CompassJobsComponent implements OnInit, OnDestroy {
